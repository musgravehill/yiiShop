...
$this->renderPartial('//catalog/_sort', array('priceMax' => $priceMax, 'priceRangeMin' => $priceRangeMin, 'priceRangeMax' => $priceRangeMax, 'tag_id'=>$tag_id,));
foreach ($products as $product) {
    ...
    echo '
        <div class="span5 well" style="height:260px;">
            <h4><a href="/' . $product['url'] . '" title="подробно о ' . $product['name'] . '" >' . $product['name'] . '</a></h4>
